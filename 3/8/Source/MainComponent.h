...
#define DELAY_BITS 0
#define NODE1_AETHERNET_IP 0xAC12010C
#define NODE2_AETHERNET_IP 0xAC12010D
#define NODE1_AETHERNET_MAC 0x114514114514
#define NODE2_AETHERNET_MAC 0x114514114514
...
#define DEVICE_NAME_AETHERNET "Network adapter 'Microsoft KM-TEST 环回适配器' on local host"
...
private:
	enum TransportState {
		...
		EthernetNode1RequestSending, EthernetNode1ReplySending
	};
	...
	void changeState(TransportState newState) {
		if (state != newState) {
			...
			case EthernetNode1RequestSending:
			case EthernetNode1ReplySending:
