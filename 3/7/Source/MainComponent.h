...
private:
	enum TransportState {
		Ready, 
		AethernetSending, AethernetReceiving, AethernetReplySending, AethernetReplyReceiving,
		EthernetReceiving, EthernetReplySending,
		EthernetNode2RequestSending, EthernetNode2ReplySending
	};
